...
export const DOH_RESOLVERS: { name: string; url: string; location: string; lat: number; lng: number }[] = [
  ...
  { name: 'LibreDNS', url: 'https://doh.libredns.gr/dns-query', location: 'Athens, GR', lat: 37.98, lng: 23.73 },
  { name: 'DNS.SB', url: 'https://doh.dns.sb/dns-query', location: 'Global (Anycast)', lat: 1.35, lng: 103.82 },
  { name: 'Comodo', url: 'https://doh.comodo.com/dns-query', location: 'US East', lat: 39.04, lng: -77.49 },
  ...
  { name: 'CleanBrowsing', url: 'https://doh.cleanbrowsing.org/doh/security-filter', location: 'US (Anycast)', lat: 41.88, lng: -87.63 },
  { name: 'Wikimedia', url: 'https://wikimedia-dns.org/dns-query', location: 'Global (Anycast)', lat: 37.39, lng: -122.08 },
  { name: 'Switch.ch', url: 'https://dns.switch.ch/dns-query', location: 'Zurich, CH', lat: 47.37, lng: 8.54 },
  { name: 'IIJ', url: 'https://public.dns.iij.jp/dns-query', location: 'Tokyo, JP', lat: 35.68, lng: 139.69 },
  { name: 'Restena', url: 'https://kaitain.restena.lu/dns-query', location: 'Luxembourg', lat: 49.61, lng: 6.13 },
];
