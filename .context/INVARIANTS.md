...
- [ ] **Dark + light theme.** Dark is default; light theme available via toggle. Both use canonical .lol family tokens.
  - _Verify:_ `:root` in `spa.ts` must have `--bg:#0a0a12`. `[data-theme="light"]` block must exist.
