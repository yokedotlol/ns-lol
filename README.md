...
| `GET /:domain/propagation` | Global propagation across 17 resolvers in US + EU (always live, never cached) |
...
- **Resolvers**: 17 public DNS resolvers across NA and EU, queried in parallel from nearest probe
